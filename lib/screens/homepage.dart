...
import 'package:mazraamarket/screens/detailss.dart';
...
class MyyHomePage extends StatelessWidget {
  const MyyHomePage({Key? key}) : super(key: key);
            ...
            children: [
              ...
              FutureBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<Itemm> itemList = snapshot.data!.docs.map((DocumentSnapshot document) {
 ...
 GestureDetector ItemC(BuildContext context, Itemm e) {
  return GestureDetector(
    onTap: () {
      Navigator.of(context).push(MaterialPageRoute(
       builder: (context) => ItemmScreen(e: e),
      ));
    },
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
